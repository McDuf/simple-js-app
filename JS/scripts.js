let pokemonList = [
    ...
    {dex: 6, name: 'Charizard', gen: 1, hp: 78, types: ['Fire', 'Flyg'], height: 5.58, weight: 1995},
    ...
    {dex: 12, name: 'Butterfree', gen: 1, hp: 60, types: ['Bug', 'Flyg'], height: 3.58, weight: 705},
    ...
    {dex: 16, name: 'Pidgey', gen: 1, hp: 40, types: ['Normal', 'Flyg'], height: 1, weight: 4},
    {dex: 17, name: 'Pidgeotto', gen: 1, hp: 63, types: ['Normal', 'Flyg'], height: 3.58, weight: 661},
    {dex: 18, name: 'Pidgeot', gen: 1, hp: 83, types: ['Normal', 'Flyg'], height: 4.08, weight: 871},
    ...
    {dex: 21, name: 'Spearow', gen: 1, hp: 40, types: ['Normal', 'Flyg'], height: 1, weight: 44},
    {dex: 22, name: 'Fearow', gen: 1, hp: 65, types: ['Normal', 'Flyg'], height: 3.08, weight: 838},
    ...
    {dex: 41, name: 'Zubat', gen: 1, hp: 40, types: ['Poison', 'Flyg'], height: 2.58, weight: 165},
    {dex: 42, name: 'Golbat', gen: 1, hp: 75, types: ['Poison', 'Flyg'], height: 5.25, weight: 1213},
    ...
    {dex: 56, name: 'Mankey', gen: 1, hp: 40, types: ['Fightg', ''], height: 1.66, weight: 617},
    {dex: 57, name: 'Primeape', gen: 1, hp: 65, types: ['Fightg', ''], height: 3.25, weight: 705},
    ...
    {dex: 62, name: 'Poliwrath', gen: 1, hp: 90, types: ['Water', 'Fightg'], height: 4.25, weight: 119},
    ...
    {dex: 66, name: 'Machop', gen: 1, hp: 70, types: ['Fightg', ''], height: 2.58, weight: 43},
    {dex: 67, name: 'Machoke', gen: 1, hp: 80, types: ['Fightg', ''], height: 4.08, weight: 1554},
    {dex: 68, name: 'Machamp', gen: 1, hp: 90, types: ['Fightg', ''], height: 5.25, weight: 2866},
    ...
    {dex: 83, name: 'Farfetch\'d', gen: 1, hp: 52, types: ['Normal', 'Flyg'], height: 2.58, weight: 331},
    {dex: 84, name: 'Doduo', gen: 1, hp: 35, types: ['Normal', 'Flyg'], height: 4.58, weight: 864},
    {dex: 85, name: 'Dodrio', gen: 1, hp: 60, types: ['Normal', 'Flyg'], height: 5.08, weight: 1878},
    ...
    {dex: 106, name: 'Hitmonlee', gen: 1, hp: 50, types: ['Fightg', ''], height: 4.08, weight: 1098},
    {dex: 107, name: 'Hitmonchan', gen: 1, hp: 50, types: ['Fightg', ''], height: 4.58, weight: 1107},
    ...
    {dex: 123, name: 'Scyther', gen: 1, hp: 70, types: ['Bug', 'Flyg'], height: 4.08, weight: 1235},
    ...
    {dex: 130, name: 'Gyarados', gen: 1, hp: 95, types: ['Water', 'Flyg'], height: 21.33, weight: 5181},
    ...
    {dex: 142, name: 'Aerodactyl', gen: 1, hp: 80, types: ['Rock', 'Flyg'], height: 5.08, weight: 1301},
    {dex: 143, name: 'Snorlax', gen: 1, hp: 160, types: ['Normal', ''], height: 6.08, weight: 10141},
    {dex: 144, name: 'Articuno', gen: 1, hp: 90, types: ['Ice', 'Flyg'], height: 5.58, weight: 1221},
    {dex: 145, name: 'Zapdos', gen: 1, hp: 90, types: ['Electric', 'Flyg'], height: 5.25, weight: 116},
    {dex: 146, name: 'Moltres', gen: 1, hp: 90, types: ['Fire', 'Flyg'], height: 6.58, weight: 1323},
    ...
    {dex: 149, name: 'Dragonite', gen: 1, hp: 91, types: ['Dragon', 'Flyg'], height: 7.25, weight: 463},
